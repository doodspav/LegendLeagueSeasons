...
##### CSV
Seasons 2018-03 and later have seperate csv files from th7-12 (th7 is only included if any got to legends that season), and all seasons have a file with all the information.
